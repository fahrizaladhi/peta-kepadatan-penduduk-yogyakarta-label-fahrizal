...
var style_Point_2 = function(feature, resolution){
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 0.0 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(0,0,0,0.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.52}), fill: new ol.style.Fill({color: 'rgba(255,255,255,0.0)'})}),
